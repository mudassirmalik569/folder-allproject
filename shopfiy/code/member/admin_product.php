...
$prodcut_query = "INSERT INTO product (type,cat_id,sub_id,pro_name,image, pro_detail,tags,price, discount) VALUES ('{$type}','{$cat_id}','{$sub_id}','{$pro_name}','{$image}','{$description}','{$new_tags}','{$price}', '{$discount}') ";
