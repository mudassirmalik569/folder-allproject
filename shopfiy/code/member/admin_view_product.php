...
<input class="btn btn-danger btn-block" style="border-radius:20px" type="submit" name="sub" value="View Product">
</div>
...
$r_query = "SELECT * FROM product WHERE sub_id = '{$sub_id}' ";
...
<td><a class="btn btn-info btn-sm" href="admin_product_view.php?view=<?php echo $pro_id ?>">View</a></td>
<td><a class="btn btn-warning btn-sm" href="admin_view_product.php?edit=<?php echo $pro_id ?>">Edit</a></td>
<td><a class="btn btn-danger btn-sm" href="admin_view_product.php?delete=<?php echo $pro_id ?>">Delete</a></td>
