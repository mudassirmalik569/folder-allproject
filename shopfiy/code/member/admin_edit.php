...
<div class="row">
<div class="col-md-12">
<h1 class="page-head-line">Updte Profile</h1>
</div>
</div>
<div class="row">
<div class="col-md-12">
...
<option value="" disabled required>Choose Role</option>
...
$sql = "UPDATE users SET name = \"$username\", email = \"$email\", password = \"$password\", contact = \"$phone\", role = \"$role\" WHERE id = \"$user_main_id\"  ";
if($db->error){
$error = $db->error;
echo $error;
}
