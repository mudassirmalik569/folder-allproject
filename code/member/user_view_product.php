...
<?php 
    ...
    if(isset($_GET['view'])){
      $product_id = $_GET['view'];
          ...
          $edit_image_side = $edit_row['side_image'];
          $edit_image_back = $edit_row['back_image'];
...
<div class="col-xs-6">
  ...
  <img src="images/<?php echo $edit_image_side ?>" style="border:1px solid black;box-shadow:0px 3px 5px black; margin-bottom:15px" class="img-response" width="100%" height="80%" />
  <img src="images/<?php echo $edit_image_back ?>" style="border:1px solid black;box-shadow:0px 3px 5px black; margin-bottom:15px" class="img-response" width="100%" height="80%" />
